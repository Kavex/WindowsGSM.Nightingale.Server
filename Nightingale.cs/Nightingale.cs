...
namespace WindowsGSM.Plugins
{
    public class Nightingale : SteamCMDAgent
    {
        ...
        {
            name = "WindowsGSM.Nightingale.Server", // WindowsGSM.XXXX
            author = "Kavex",
            description = "WindowsGSM plugin for supporting Nightingale Dedicated Server",
            version = "1.0",
            url = "https://github.com/Kavex/WindowsGSM.Nightingale.Server", // Github repository link (Best practice)
        ...
        public override string StartPath => @"NWXServer.exe"; // Game server start path
        ...
        public async Task<Process> Start()
        {
            ...
            string param = "NWXServer -log -unattended";
